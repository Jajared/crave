...
class RealCameraScreen extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RealCameraScreenState();
}

class _RealCameraScreenState extends ConsumerState<RealCameraScreen>
  ...
  void initState() {
    ...
    _triggerBtnAnimationController = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 200));
    _triggerBtnAnimation = Tween<double>(begin: 1, end: 0.8).animate(
        CurvedAnimation(
            parent: _triggerBtnAnimationController, curve: Curves.easeInOut));
                    ...
                    finalized: (location, photo) =>
                      ...
                      Align(
                        ...
                        child: IconButton(
                            onPressed: () {
                              ref
                                  .read(realCameraControllerProvider.notifier)
                                  .init();
                            },
