...
class _DigitWidgetState extends ConsumerState<DigitWidget>
  ...
  void initState() {
    ...
    _opacityAnimationOne = Tween<double>(
      begin: 1.0,
        ...
        curve: const Interval(0.2, 0.3, curve: Curves.ease)));
                ...
                Opacity(
                  ...
                  child: ClipRect(
                    ...
                    child: FractionalTranslation(
                        ...
                        child: Text(widget.currentDigit.toString(),
                            style: widget.style)),
                  ),
                ),
                Opacity(
                  ...
                  child: ClipRect(
                    ...
                    child: FractionalTranslation(
                        ...
                        child: Text(widget.nextDigit.toString(),
                            style: widget.style)),
                  ),
                )
              ],
